...
func TestTemplateAutoEscapeWeb(t *testing.T) {
...
func TemplateAutoEscapeDisabled(writer http.ResponseWriter, request *http.Request) {
	myTemplate.ExecuteTemplate(writer, "post.gohtml", map[string]interface{}{
		"Title": "Golang Auto Escape",
		"Body":  template.HTML("<h1>Selamat Belajar Golang Web</h1>"),
	})
}
...
func TestTemplateAutoEscapeDisabledWeb(t *testing.T) {
...
func TestTemplateXSS(t *testing.T) {
	request := httptest.NewRequest("GET", "http://localhost:8080/?body=<script>alert('anda_di_hack')</script>", nil)
	recorder := httptest.NewRecorder()
...
func TestTemplateXSSWeb(t *testing.T) {
